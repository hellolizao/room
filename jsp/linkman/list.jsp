										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称:</TD>
													<TD>
													<s:textfield theme="simple" name="lkm_name" cssClass="textbox" cssStyle="WIDTH: 80px" maxlength="30"/>
													</TD>
													<TD>联系人性别:</TD>
													<TD>
													<s:select  list="#{'1':'男' , '2':'女' }" headerKey="" headerValue="-请选择-" theme="simple" name="lkm_gender"></s:select>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<!--必须是单引号在外面，里面的必须是双引号，这样才能识别为字符串，而不是识别为字符-->
