										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>从拜访时间:</TD>
													<TD>
														<%--这里必须是使用普通的<input>标签来的回显--%>
<%--														<input type="text" readonly="true" name="visit_time" id="visit_time" value="<s:date name="visit_time" format="yyyy-MM-dd"/> " >--%>
<%--													<s:textfield theme="simple" name="visit_time"  id="visit_time" cssClass="textbox" cssStyle="WIDTH: 80px" maxlength="30"/>--%>

                                                            <input type="text" id="visit_time" name="visit_time" readonly="readonly" value="<s:date name="visit_time" format="yyyy-MM-dd"/>"/>
														<%--这里使用input标签是为了可以嵌套使用的struts的<s:date>标签。因为struts的标签是不可以嵌套的--%>
													</TD>
													<TD>到拜访时间:</TD>
													<TD>
														<input type="text" readonly="true" name="visit_end_time" id="visit_end_time" value="<s:date name="visit_end_time" format="yyyy-MM-dd"/>"/>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="user.user_name"/></TD><!--业务员的名称-->
													<TD>
													...
													<TD>
														...
														<%--<s:property value="visit_time"/>上面这个是去掉日期中的具体的时间--%>
													...
													<TD>
														...
														<%--<s:property value="visit_nexttime"/>--%>
													</TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												条
                                                <s:if test="currPage!=1"><!--当前页不是"1"的时候才显示-->
                                               ...
                                               &nbsp;&nbsp; </B>
                                                <s:if test="currPage!=totalPage"><!--当前页不是"最后一页"的时候才显示-->
